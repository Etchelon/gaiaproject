...
import { executePlayerAction, selectHasExecutedAction, selectIsExecutingAction } from "../store/actions-thunks";
...
const StatusBar = ({ game, playerId }: StatusBarProps) => {
	...
	const hasExecutedAction = useSelector(selectHasExecutedAction);
	const isIdle = !isExecutingAction && !hasExecutedAction;
	const statusBarMessage = isExecutingAction ? "Executing..." : hasExecutedAction ? "Action executed. Waiting for update..." : statusMessage;
